...
export default {
    ...
    methods: {
        receiveItems() {
            this.receiveParams.transaction_id = this.transaction.id;
            this.receiveParams.transaction_type = this.transaction.type;
            this.receiveParams.items = this.transaction.items.map((item) => ({
                item_id: item.item.id,
                quantity: item.quantity,
                quantity_ship: item.quantity_ship,
            }));
            this.$emit("close");
            this.$emit("receiveItems", this.receiveParams);
        },
    },
    components: {
        DataTable,
