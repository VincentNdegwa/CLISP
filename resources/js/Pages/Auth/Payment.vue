    ...
    >
        ...
        <div class="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-3xl font-bold text-white">Make Your Payment</h1>
                <p class="mt-4 text-slate-300">
                    Complete your payment to activate your subscription.
                </p>
                <h3 class="text-2xl font-bold text-rose-400 mt-4">
            ...
            <form @submit.prevent="makePayment" class="mt-8 space-y-6">
                <div class="bg-white/10 backdrop-blur-sm border border-white/10 p-8 rounded-lg shadow-lg">
                    <div class="space-y-5">
                        <div>
                            <InputLabel for="cardName" value="Cardholder Name" class="text-white text-sm font-medium mb-2" />
                            <TextInput
                                id="cardName"
                                type="text"
                            ...
                            />
                            <InputError class="mt-2 text-rose-400" :message="form.errors.cardName" />
                        </div>

                        <div>
                            <InputLabel for="cardNumber" value="Card Number" class="text-white text-sm font-medium mb-2" />
                            <TextInput
                                id="cardNumber"
                                type="text"
                                class="block w-full bg-white/5 border-white/10 focus:border-rose-500 focus:ring focus:ring-rose-500/20 rounded-lg shadow-sm text-white"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <InputLabel for="expiryDate" value="Expiry Date" class="text-white text-sm font-medium mb-2" />
                                <TextInput
                                    id="expiryDate"
                                    type="text"
                                    class="block w-full bg-white/5 border-white/10 focus:border-rose-500 focus:ring focus:ring-rose-500/20 rounded-lg shadow-sm text-white"
                            ...
                            <div>
                                <InputLabel for="cvc" value="CVC" class="text-white text-sm font-medium mb-2" />
                                <TextInput
                                    id="cvc"
                                    type="text"
                                    class="block w-full bg-white/5 border-white/10 focus:border-rose-500 focus:ring focus:ring-rose-500/20 rounded-lg shadow-sm text-white"
                                    ...
                                    placeholder="CVC"
                                />
                                <InputError class="mt-2 text-rose-400" :message="form.errors.cvc" />
                            </div>
                        </div>

                        <div>
                            <InputLabel for="billingAddress" value="Billing Address" class="text-white text-sm font-medium mb-2" />
                            <TextInput
                                id="billingAddress"
                                type="text"
                                class="block w-full bg-white/5 border-white/10 focus:border-rose-500 focus:ring focus:ring-rose-500/20 rounded-lg shadow-sm text-white"
