...
<template>
    ...
    >
            ...
            <div class="relative">
                ...
                <div class="relative z-10 flex justify-between items-center">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span class="mt-2 text-xs text-rose-400 font-medium">Payment</span>
                    </div>
                    
                    <div class="flex flex-col items-center">
                        <div class="w-8 h-8 rounded-full bg-rose-500 flex items-center justify-center text-white font-semibold shadow-lg shadow-rose-500/30">5</div>
                        <span class="mt-2 text-xs text-rose-400 font-medium">Complete</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white/10 backdrop-blur-sm border border-white/10 p-8 rounded-lg shadow-lg">
                <div class="text-center">
                    ...
                    <p class="mt-4 text-slate-300">
                        Thank you for registering with CLISP. Your account has been successfully created.
                    </p>
                    
                    <div class="mt-8 p-6 bg-white/5 rounded-lg border border-white/10">
                        <h2 class="text-xl font-semibold text-rose-400">Your Subscription Details</h2>
                        <div class="mt-4 space-y-3 text-left">
                            <div class="flex justify-between">
                                <span class="text-slate-300">Plan:</span>
                                <span class="text-white font-medium">{{ form.subscription.plan }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-slate-300">Amount:</span>
                                <span class="text-white font-medium">{{ form.subscription.amount }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-slate-300">Billing Cycle:</span>
                                <span class="text-white font-medium">{{ form.subscription.billing_cycle }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-slate-300">Start Date:</span>
                                <span class="text-white font-medium">{{ form.subscription.start_date }}</span>
                            </div>
                        </div>
                    </div>
                    
                    <div class="mt-8">
                        <PrimaryButton @click="redirectToDashboard" class="inline-block w-full py-3 bg-rose-500 hover:bg-rose-600 text-white font-medium rounded-lg shadow-lg shadow-rose-500/20 hover:shadow-rose-500/40 transition-all">
                            Go to Dashboard
                        </PrimaryButton>
                    </div>
                </div>
