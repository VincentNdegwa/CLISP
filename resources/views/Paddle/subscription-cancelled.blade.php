    ...
    <div class="min-h-screen flex items-center justify-center">
        ...
        <div class="bg-white shadow-md rounded-lg w-full max-w-md p-8">
            ...
            <div class="text-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">Subscription Cancelled</h1>
                <p class="text-gray-600 mt-2">Your subscription has been cancelled. We're sorry to see you go.</p>
            </div>
            ...
            <a href="{{ route('dashboard') }}"
                class="w-full block bg-blue-600 hover:bg-blue-700 text-white text-md font-medium p-3 rounded-md text-center">
                Return to Dashboard
            </a>
        </div>
    </div>
